                            ...
                            <div className="relative">
                                ...
                                {dropdownOpen && (
                                    <>
                                        ...
                                        <div className="absolute top-full left-0 w-full bg-gray-200 border border-[#ed6f00] rounded-xl shadow-xl mt-1 z-50 overflow-y-auto max-h-[190px]">
                                            {consultants.map(c => (
                                                <div
                                                    key={c.id}
                                                    onClick={() => {
                                                    ...
                                                    className="px-4 py-2.5 hover:bg-[#ed6f00] hover:text-white cursor-pointer text-sm transition-colors"
                                                >
                                                    {c.name} ({c.phone})
                                                </div>
                                            ))}
