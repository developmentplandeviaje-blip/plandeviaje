...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    return (
        <aside className={`
            w-64 bg-white border-r border-gray-200 flex flex-col h-screen fixed inset-y-0 left-0 z-50
            transition-transform duration-300 ease-in-out
            /* Desktop: Siempre visible */
            lg:translate-x-0 lg:shadow-none
            /* Mobile: Controlado por el estado isOpen */
        ...
        `}>
            ...
            <div className="flex flex-col h-full overflow-y-auto custom-scrollbar">
                ...
                <div className="sticky top-0 z-10 bg-white flex items-center justify-between px-4 py-4 border-b border-gray-100">
                    ...
                    {/* Botón cerrar opcional para móvil si se prefiere dentro */}
                    <button onClick={toggleSidebar} className="lg:hidden text-[#001f6c] p-1">
                        <X size={20} />
                    </button>
                </div>
                ...
                {/* Bottom */}
                <div className="mt-auto px-3 py-3 border-t border-gray-100 space-y-0.5 relative">
